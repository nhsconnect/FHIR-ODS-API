...
The FHIR&reg; ODS Lookup API within this site have been developed by NHS Digital. The API aims to  better support the delivery of care by opening up information and data stored by the Organizational Data Service (ODS).
...
This guide has been created to support the adoption of the FHIR&reg; ODS Lookup profiles and FHIR resources. As such the site is structured around stakeholders including API users, developers and architects, who have an interest in implementing the FHIR&reg; ODS Lookup API.  
...
{% include custom/contribute.html content="To get involved in any parts of the roadmap or to discuss the other elements please get in touch with interoperabilityteam@nhs.net "%}
